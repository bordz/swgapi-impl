node('swarm') {
   ...
   stage('Stage Application') {
      // Run the maven build
      sh "rancher-compose --url http://139.162.118.183:8080/v1/projects/1a549 --access-key B5AAE7FE856D687A4E86 --secret-key 3syLvkMN3QMXG3chMkuhjEaZMziS9EFFWZCMpPgU --project-name swgapi --verbose up -d"
   }
   stage('Run load test') {
      // Run the maven build
      // sh "TBD"
